  ...
  getPath = (name, props) => {
    switch (name) {
      ...
      case "barchart":
        return (
          <React.Fragment>
            <line x1="18" y1="20" x2="18" y2="10" {...props}></line>
            <line x1="12" y1="20" x2="12" y2="4" {...props}></line>
            <line x1="6" y1="20" x2="6" y2="14" {...props}></line>
          </React.Fragment>
        );
      case "checkcircle":
        return (
          <React.Fragment>
            <path d="M22 11.08V12a10 10 0 1 1-5.93-9.14" {...props}></path>
            <polyline points="22 4 12 14.01 9 11.01" {...props}></polyline>
          </React.Fragment>
        );
      ...
      case "dollarsign":
        return (
          <React.Fragment>
            <line x1="12" y1="1" x2="12" y2="23" {...props}></line>
            <path
      ...
      case "helpcircle":
        return (
          <React.Fragment>
            <circle cx="12" cy="12" r="10" {...props}></circle>
            <path d="M9.09 9a3 3 0 0 1 5.83 1c0 2-3 3-3 3" {...props}></path>
            <line x1="12" y1="17" x2="12.01" y2="17" {...props}></line>
          </React.Fragment>
        );
      case "lock":
        return (
          <React.Fragment>
            <rect
              ...
              {...props}
            ></rect>
            <path d="M7 11V7a5 5 0 0 1 10 0v4" {...props}></path>
          </React.Fragment>
        );
      case "power":
        return (
          <React.Fragment>
            <path d="M18.36 6.64a9 9 0 1 1-12.73 0" {...props}></path>
            <line x1="12" y1="2" x2="12" y2="12" {...props}></line>
          </React.Fragment>
        );
      case "search":
        return (
          <React.Fragment>
            <circle cx="11" cy="11" r="8" {...props}></circle>
            <line x1="21" y1="21" x2="16.65" y2="16.65" {...props}></line>
          </React.Fragment>
        );
      case "sliders":
        return (
          <React.Fragment>
            <line x1="4" y1="21" x2="4" y2="14" {...props}></line>
            <line x1="4" y1="10" x2="4" y2="3" {...props}></line>
            <line x1="12" y1="21" x2="12" y2="12" {...props}></line>
            <line x1="12" y1="8" x2="12" y2="3" {...props}></line>
            <line x1="20" y1="21" x2="20" y2="16" {...props}></line>
            <line x1="20" y1="12" x2="20" y2="3" {...props}></line>
            <line x1="1" y1="14" x2="7" y2="14" {...props}></line>
            <line x1="9" y1="8" x2="15" y2="8" {...props}></line>
            <line x1="17" y1="16" x2="23" y2="16" {...props}></line>
          </React.Fragment>
        );
      case "telescope":
        return (
      ...
      case "trash":
        return (
          <React.Fragment>
            <polyline points="3 6 5 6 21 6" {...props}></polyline>
            <path
              d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"
              {...props}
            ></path>
            <line x1="10" y1="11" x2="10" y2="17" {...props}></line>
            <line x1="14" y1="11" x2="14" y2="17" {...props}></line>
          </React.Fragment>
        );
      case "user":
        return (
          <React.Fragment>
            <path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2" {...props} />
            <circle cx="12" cy="7" r="4" {...props}></circle>
          </React.Fragment>
        );
      case "users":
        return (
          <React.Fragment>
            <path
              ...
              {...props}
            ></path>
            <circle cx="9" cy="7" r="4" {...props}></circle>
            <path d="M23 21v-2a4 4 0 0 0-3-3.87" {...props}></path>
            <path d="M16 3.13a4 4 0 0 1 0 7.75" {...props}></path>
          </React.Fragment>
        );
      default:
        return <path />;
